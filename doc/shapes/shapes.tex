...
\[  \left[ \Indicator{l} \Convolution \PositiveTriangle{c} \right] (x) = \begin{cases}
    0 & x \le -\frac{l}{2} \\
...
\paragraph{Case 1: No overlap, left}
...
\paragraph{Case 2: Partial left overlap}
...
\paragraph{Case 3: Complete inclusion}
...
\paragraph{Case 4: Partial right overlap}
...
\paragraph{Case 5: No overlap, right}
