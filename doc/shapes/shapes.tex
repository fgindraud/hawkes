...
\begin{center}\begin{tikzpicture}
    % Grid, axis, ticks
    \draw[very thin,color=gray] (-3.5,-0.5) grid (4.5,1.7);
    ...
    \node[below right] at (1,0) {$1$};
    % B
    \draw[color=blue] (-1.5,0) -- (-1.5,1) -- (1.5,1) -- (1.5,0);
    \node[below,color=blue] at (-1.5,0) {$-\frac{b}{2}$};
    \node[below,color=blue] at (1.5,0) {$\frac{b}{2}$};
    % A
    \draw[color=red] (2.5,0) -- (2.5,1) -- (3.5,1) -- (3.5,0);
    \draw[dashed,color=red] (2.5,0) -- (2.5,-0.5) node[below,color=red] {$x-\frac{a}{2}$};
    \draw[dashed,color=red] (3.5,0) -- (3.5,-0.5) node[below,color=red] {$x+\frac{a}{2}$};
\end{tikzpicture}\end{center}
...
\begin{center}\begin{tikzpicture}
    ...
    \node[below,color=blue] at (1.5,0) {$\frac{b}{2}$};
    % A
    \draw[color=red] (1,0) -- (1,1) -- (2,1) -- (2,0);
    \draw[dashed,color=red] (1,0) -- (1,-0.5) node[below,color=red] {$x-\frac{a}{2}$};
    \draw[dashed,color=red] (2,0) -- (2,-0.5) node[below,color=red] {$x+\frac{a}{2}$};
\end{tikzpicture}\end{center}
\[
    C_{a,b}(x) =
...
\begin{center}\begin{tikzpicture}
    ...
    \node[below,color=blue] at (1.5,0) {$\frac{b}{2}$};    \node[below right] at (1,0) {$1$};
    % A
    \draw[color=red] (0.3,0) -- (0.3,1) -- (1.3,1) -- (1.3,0);
    \draw[dashed,color=red] (0.3,0) -- (0.3,-0.5) node[below,color=red] {$x-\frac{a}{2}$};
    \draw[dashed,color=red] (1.3,0) -- (1.3,-0.5) node[below,color=red] {$x+\frac{a}{2}$};
\end{tikzpicture}\end{center}
